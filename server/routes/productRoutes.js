...
router.get('/products/get-admin-products', adminAuth, getAdminProducts);
router.post('/products/bulk-update', adminAuth, bulkUpdateProducts);
router.post('/products/bulk-update-moq', adminAuth, bulkUpdateMOQ);
router.delete('/products/delete/:id', deleteProduct);
router.delete('/products/delete-many', deleteManyProducts);
