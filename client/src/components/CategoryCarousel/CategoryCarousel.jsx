    ...
    return (
        <section className="pt-4 pb-4 md:pt-8 lg:pt-12 lg:pb-12 bg-white overflow-hidden relative">
            <div className="relative z-10">
                {/* Standardized Header - Hidden on Mobile */}
                <div className="hidden md:block pl-6 lg:pl-16 pr-6 mb-8">
                    <div className="flex flex-col gap-3">
                        <span className="text-[10px] font-bold tracking-[0.4em] text-primary-gold uppercase py-1.5 px-4 border border-primary-gold/20 bg-primary-gold/5 rounded-full w-fit inline-block">
                            Exclusives
                        </span>
