                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
                        ...
                        <div className="md:col-span-12 space-y-6">
                            <p className="text-[14px] text-charcoal/70 leading-relaxed font-body">
                                Your current bag contains items from a different collection. To maintain wholesale efficiency, you must select either <span className="text-deep-black font-semibold">18k Gold</span> or <span className="text-deep-black font-semibold">316L Steel</span> separately per order.
                            </p>
